...
const styles = StyleSheet.create({
  ...
  codeChip: { alignSelf: 'flex-start', backgroundColor: brandColors.accent100, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6, marginBottom: 10 },
  ...
  favBtn: { height: 48, borderRadius: 999, alignItems: 'center', justifyContent: 'center' },
